...
- [1](https://www.algoexpert.io/questions/river-sizes)
- review yesterday exercises
...
### return longest contiguous subarray with at most 2 distinct elements

#### My solution
[0,1,2,3,2,2,3,1]
- compare parent array with child array
- select i from parent
- select j as i+1 from parent. if j == i, move j across parent array until j != i
- iterate through child array. if child array pos contains i or j add to count
