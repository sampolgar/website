...
summary: 'Why interacting with a Web 3 protocol like Aave appears like a bank, but differs “under the hood”'
image: ''
---

import Image from 'next/image';
import aethervdiscord from '../../public/web3-protocols-not-apps/Web2vsWeb3stack.png';
import aethervdiscord2 from 'public/images/blog/web3-protocols-not-apps/aethervdiscord.png';
